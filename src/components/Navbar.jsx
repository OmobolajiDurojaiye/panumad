        ...
        <div className="max-w-7xl mx-auto px-10 flex justify-between items-center py-3">
          ...
          <Link to="/" className="flex items-center group">
            ...
            <div className="flex flex-col ml-3">
              <span className="font-bold text-lg text-white tracking-tight uppercase leading-none">
                Panum A.D.{" "}
                <span className="text-brand-lightBlue font-light">
                  Structures
                </span>
              </span>
              <span className="text-[7px] text-gray-400 font-bold tracking-[0.2em] mt-0.5">
                RC. 9473228
              </span>
            </div>
          </Link>
      ...
      <header className="w-full relative z-50 bg-white">
        ...
        <div className="flex w-full bg-black text-white text-[10px] sm:text-[11px] md:text-xs py-1.5 md:py-2.5 px-1 sm:px-2 md:px-10 flex-row justify-between items-center tracking-tighter sm:tracking-tight md:tracking-wider overflow-hidden">
          ...
          <div className="flex flex-row items-center space-x-1 sm:space-x-2 md:space-x-5 opacity-70">
            <span className="mr-2 font-bold text-[10px] uppercase hidden lg:inline">
              Follow Our Engineering Journey:
            </span>
            <a
              href="https://www.facebook.com/profile.php?id=61556390253262"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://x.com/panum_adstruc"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/panuma.d.struct?igsh=NndkZ29yd2JiN3Qy"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <div className="flex justify-between items-center px-4 md:px-10 py-6 border-b border-gray-100 shadow-sm">
          ...
          <Link to="/" className="flex items-center group">
            ...
            <div className="ml-2 md:ml-4 flex flex-col justify-center">
              <span className="block font-black text-sm sm:text-lg md:text-3xl tracking-tighter text-brand-blue leading-none mt-1 sm:mt-0">
                PANUM A.D. STRUCTURES
              </span>
              <span className="block text-[8px] md:text-[10px] font-bold text-gray-400 tracking-[0.3em] mt-0.5 ml-0.5">
                RC. 9473228
              </span>
            </div>
          </Link>
          ...
          <nav className="hidden lg:flex space-x-10">
            {navLinks.map((link) => (
              ...
              >
                ...
                <span
                  className={`absolute bottom-0 left-0 h-0.5 bg-brand-lightBlue transition-all duration-300 ${
                    location.pathname === link.path
                      ? "w-full"
        ...
        >
          ...
          <div className="flex items-center justify-center p-6 border-b border-gray-100 relative bg-gray-50">
            ...
            <span className="text-gray-400 text-xs font-bold tracking-[0.3em] uppercase">
              Menu
            </span>
          </div>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`flex items-center justify-between p-6 border-b border-gray-50 transition-all duration-300 ${
                  location.pathname === link.path
                    ? "bg-blue-50/50 text-brand-lightBlue"
              ...
              >
                ...
                <ChevronRight
                  size={18}
                  className={`${location.pathname === link.path ? "text-brand-lightBlue" : "text-gray-300"}`}
                />
              </Link>
            ))}
            ...
            <div className="p-8 mt-10">
              ...
              <div className="mt-10 flex justify-center space-x-8 opacity-40">
                ...
                >
                  <Facebook
                    size={20}
                    className="hover:text-brand-lightBlue transition"
                  />
                </a>
                <a
                  href="https://x.com/panum_adstruc"
