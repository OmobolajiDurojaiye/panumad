      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              <Link to="/about#ceo-message">CEO's Message</Link>
            </li>
            <li>
              <Link to="/about#who-we-are">Our Team</Link>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              <Link to="/projects">Commercial Buildings</Link>
            </li>
            <li>
      ...
      <div className="max-w-7xl mx-auto border-t border-brand-blue mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-400">
        <div className="flex flex-col items-center md:items-start">
          <p className="hover:text-white transition cursor-pointer text-center md:text-left">
            <Link to="/">
              © 2026 Panum A.D. Structures (Rc. 9473228). All rights reserved.
            </Link>
          </p>
        ...
        <div className="flex space-x-4 mt-6 md:mt-0 items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-green-600 p-1 rounded-full hover:scale-110 transition"
          >
